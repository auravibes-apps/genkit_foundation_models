...
class NativeGenerateStreamEvent {
  ...
  bool operator ==(Object other) {
    ...
    return _deepEquals(requestId, other.requestId) && _deepEquals(parts, other.parts) && _deepEquals(done, other.done) && _deepEquals(response, other.response) && _deepEquals(errorCode, other.errorCode) && _deepEquals(errorMessage, other.errorMessage);
  }
